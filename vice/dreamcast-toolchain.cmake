...
set(CMAKE_EXE_LINKER_FLAGS "${KOS_LDFLAGS} ${KOS_LIB_PATHS} -L/opt/toolchains/dc/sh-elf/sh-elf/lib/ -L/opt/toolchains/dc/kos/addons/lib/dreamcast/ -L/opt/toolchains/dc/kos/lib/dreamcast/ ${KOS_LIBS} -lSDL -lstdc++ -lc -lgcc")
...
set(LIB_KALLISTI "${KOS_LDFLAGS};${KOS_LIB_PATHS};kallisti;c;gcc;SDL;stdc++")
