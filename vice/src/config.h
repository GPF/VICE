...
#define CONFIGURE_FLAGS "--program-prefix=/cd/Vice/ --host=sh-elf --enable-sdl1ui --enable-x64 --without-sdlsound --with-fastsid --disable-realdevice --without-resid --disable-portaudio --disable-ahi --disable-midi --disable-lame --disable-hardsid --disable-catweasel --disable-ssi2001 --disable-parsid --disable-ethernet --disable-ipv6 --disable-html-docs --disable-pdf-docs --disable-debug --disable-debug-gtk3ui --disable-cpuhistory --disable-native-gtk3ui --disable-headlessui --disable-hidmgr --disable-hidutils --disable-rs232 --without-readline --without-pulse --without-alsa --without-oss --without-sun --without-jpeg --without-png --without-gif --without-glew --disable-gtk3ui --without-libcurl --disable-new8580filter --cache-file=config.cache host_alias=sh-elf CC=/opt/toolchains/dc/sh-elf/bin/sh-elf-gcc CFLAGS= -O2 -fomit-frame-pointer -fno-builtin -m4-single-only -ml -ffunction-sections -fdata-sections -matomic-model=soft-imask -ftls-model=local-exec -D__DREAMCAST__  -I/opt/toolchains/dc/kos/include -I/opt/toolchains/dc/kos/kernel/arch/dreamcast/include -I/opt/toolchains/dc/kos/addons/include -I/opt/toolchains/dc/kos-ports/include -D_arch_dreamcast -D_arch_sub_pristine -Wall -g LDFLAGS= -O2 -fomit-frame-pointer -fno-builtin -m4-single-only -ml -ffunction-sections -fdata-sections -matomic-model=soft-imask -ftls-model=local-exec -D__DREAMCAST__  -I/opt/toolchains/dc/kos/include -I/opt/toolchains/dc/kos/kernel/arch/dreamcast/include -I/opt/toolchains/dc/kos/addons/include -I/opt/toolchains/dc/kos-ports/include -D_arch_dreamcast -D_arch_sub_pristine -Wall -g  -m4-single-only -ml -Wl,-Ttext=0x8c010000 -Wl,--gc-sections -T/opt/toolchains/dc/kos/utils/ldscripts/shlelf.xc -nodefaultlibs -L/opt/toolchains/dc/kos/lib/dreamcast -L/opt/toolchains/dc/kos/addons/lib/dreamcast -L/opt/toolchains/dc/kos-ports/lib LIBS=-Wl,--start-group -lkallisti -lm -lc -lgcc -lstdc++ -lkallisti -Wl,--end-group CXX=/opt/toolchains/dc/sh-elf/bin/sh-elf-g++ PKG_CONFIG=./sh-elf-pkg-config --no-create --no-recursion"
